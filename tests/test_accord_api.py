"""
Tests for CIRIS Accord API - Trace Levels, IDMA, and Correlation Metadata.

Tests cover:
- CorrelationMetadata model validation
- AccordEventsRequest with trace_level and correlation_metadata
...
# =============================================================================
# AccordEventsRequest Model Tests
# =============================================================================


class TestAccordEventsRequest:
    """Tests for AccordEventsRequest Pydantic model."""

    def test_minimal_request(self, sample_trace):
        """Test creating minimal request with defaults."""
        event = AccordTraceEvent(event_type="complete_trace", trace=sample_trace)
    ...
    def test_request_multiple_events(self, sample_trace):
        ...
        events = [
            AccordTraceEvent(event_type="complete_trace", trace=sample_trace),
            AccordTraceEvent(event_type="complete_trace", trace=sample_trace),
            AccordTraceEvent(event_type="complete_trace", trace=sample_trace),
        ]
        request = AccordEventsRequest(
